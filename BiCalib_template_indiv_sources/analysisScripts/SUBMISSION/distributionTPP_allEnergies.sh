...
s|UTILS_PLACEHOLDER|../../ROOT|g" "../ROOT/distributionTPP_allEnergies_chainROOT.cpp" > "../${DST_DIR}/distributionTPP_allEnergies_chainROOT_Source_${i}_${k}.cpp"
	
(cd "../../SOURCES/Source_${i}_${k}/DATA/ROOTFiles" && root -l -b -q "${BASE_DIR}/${DST_DIR}/distributionTPP_allEnergies_chainROOT_Source_${i}_${k}.cpp")
