#!/bin/bash
#SBATCH --job-name=distTPP_600_800keV
#SBATCH --array=1-42
...
s|UTILS_PLACEHOLDER|../../ROOT|g" "../ROOT/distributionTPP_600_800keV_chainROOT.cpp" > "../${DST_DIR}/distributionTPP_600_800keV_chainROOT_Source_${i}_${k}.cpp"
	
(cd "../../SOURCES/Source_${i}_${k}/DATA/ROOTFiles" && root -l -b -q "${BASE_DIR}/${DST_DIR}/distributionTPP_600_800keV_chainROOT_Source_${i}_${k}.cpp")
